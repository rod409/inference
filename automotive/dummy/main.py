...
def main():
    ...
    ds = dataset_class(dataset_path=args.dataset_path)
    ...
    scene_lengths = np.array([39, 40, 40, 39, 39, 39, 40, 40, 40, 40, 40, 39, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 39, 40])
    print(sum(scene_lengths))
